...
if platform == "win32":
    ...
    system("rd /s /q dist")
    system("del /q *.spec")
    system(f'pyinstaller --noconfirm --onefile --windowed --uac-admin --icon "../ICO/tlauncher.ico" --add-data "C:/Users/{user}/AppData/Local/Programs/Python/Python312/Lib/site-packages/customtkinter;customtkinter/" "../main.pyw"')
    system("del /q *.spec")
    system("rd /s /q build")
